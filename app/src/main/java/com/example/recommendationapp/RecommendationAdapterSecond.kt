...
class RecommendationAdapterSecond(private val recommendedProduct: ProductListSecond?) : RecyclerView.Adapter<RecommendationAdapterSecond.RecommendationViewHolder>() {
...
//        val (productName, productId) = currentItem.split(" ")
        val product = recommendedProduct // Retrieve product name and ID from Pair
